...
- Name: sidebar-sessions.spec.ts >> pin via the row menu moves the session to the Pinned band and back
- Location: e2e\sidebar-sessions.spec.ts:65:1
...
Locator: getByTitle('Weekly plan 4')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTitle('Weekly plan 4')
