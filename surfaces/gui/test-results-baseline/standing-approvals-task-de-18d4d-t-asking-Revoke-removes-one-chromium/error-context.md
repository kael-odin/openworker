...
- Name: standing-approvals.spec.ts >> task detail lists standing rules under 'Allowed without asking'; Revoke removes one
- Location: e2e\standing-approvals.spec.ts:80:1
