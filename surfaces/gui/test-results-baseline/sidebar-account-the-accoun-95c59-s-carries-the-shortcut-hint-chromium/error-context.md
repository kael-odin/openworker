...
- Name: sidebar-account.spec.ts >> the account menu: Inbox + Connectors always listed; Settings carries the shortcut hint
- Location: e2e\sidebar-account.spec.ts:27:1
