...
- Name: unattended.spec.ts >> Send-to-Inbox toggle (in the Mode menu) flips and persists across a reload
- Location: e2e\unattended.spec.ts:24:1
...
Call log:
  - waiting for getByRole('button', { name: 'Mode', exact: true })
