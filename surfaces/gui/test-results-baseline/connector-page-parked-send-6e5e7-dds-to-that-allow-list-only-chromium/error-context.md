...
- Name: connector-page.spec.ts >> parked sender files under ITS workspace; Allow & deliver adds to that allow-list only
- Location: e2e\connector-page.spec.ts:27:1
