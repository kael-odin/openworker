...
- Name: sidebar-automations.spec.ts >> nav row + Scheduled band render with unseen badges; runs stay out of Recent
- Location: e2e\sidebar-automations.spec.ts:9:1
...
Locator: getByTestId('nav-automations')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('nav-automations')
