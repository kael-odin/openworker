...
- Name: onboarding.spec.ts >> key form: revisiting a connected provider shows the in-field saved state; drafts survive switching
- Location: e2e\onboarding.spec.ts:72:1
