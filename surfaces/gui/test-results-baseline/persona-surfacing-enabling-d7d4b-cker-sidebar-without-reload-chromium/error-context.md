...
- Name: persona-surfacing.spec.ts >> enabling an installed persona surfaces it in picker + sidebar without reload
- Location: e2e\persona-surfacing.spec.ts:12:1
...
Call log:
  - waiting for getByLabel('Choose a persona')
