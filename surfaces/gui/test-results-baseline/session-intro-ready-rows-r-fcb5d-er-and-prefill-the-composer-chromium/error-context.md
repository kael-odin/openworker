...
- Name: session-intro.spec.ts >> ready rows reveal Start → on hover and prefill the composer
- Location: e2e\session-intro.spec.ts:38:1
...
Locator: getByTestId('intro-task-hubspot')
Expected substring: "Start →"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for getByTestId('intro-task-hubspot')
