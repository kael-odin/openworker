...
- Name: cloud-status-pending.spec.ts >> pending status shows 'checking', never the sign-in ask; resolves to one-click
- Location: e2e\cloud-status-pending.spec.ts:17:1
