...
- Name: sidebar-sessions.spec.ts >> archive via the row menu is reversible via the Archived disclosure
- Location: e2e\sidebar-sessions.spec.ts:21:1
...
Locator: getByTitle('Weekly plan 2')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTitle('Weekly plan 2')
