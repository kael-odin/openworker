...
- Name: session-intro.spec.ts >> folder task opens the inline add-folder form; adding a folder prefills the composer
- Location: e2e\session-intro.spec.ts:73:1
...
Call log:
  - waiting for getByTestId('intro-task-folder')
