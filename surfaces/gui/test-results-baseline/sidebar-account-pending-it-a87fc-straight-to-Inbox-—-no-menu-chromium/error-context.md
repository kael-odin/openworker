...
- Name: sidebar-account.spec.ts >> pending items: the chip carries the count and goes straight to Inbox — no menu
- Location: e2e\sidebar-account.spec.ts:16:1
...
Locator: getByTestId('inbox-chip')
Expected pattern: /\d/
Timeout: 5000ms
