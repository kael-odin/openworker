...
- Name: sidebar-sessions.spec.ts >> delete is two-step: the menu's Delete arms, Delete? confirms
- Location: e2e\sidebar-sessions.spec.ts:89:1
...
Locator: getByTitle('Weekly plan 3')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTitle('Weekly plan 3')
