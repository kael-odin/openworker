...
- Name: sidebar-automations.spec.ts >> opening a Scheduled entry lands on the detail, marks seen, clears the badge
- Location: e2e\sidebar-automations.spec.ts:34:1
...
Call log:
  - waiting for getByTestId('scheduled-task-1')
