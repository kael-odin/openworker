...
- Name: automations-quickstart.spec.ts >> role recipe: connect rows, lazy single sign-in, channel by name, consent mints the grant
- Location: e2e\automations-quickstart.spec.ts:24:1
