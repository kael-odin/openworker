...
- Name: automations-quickstart.spec.ts >> connect narrates itself: Opening browser → waiting strip → Cancel restores the button
- Location: e2e\automations-quickstart.spec.ts:65:1
